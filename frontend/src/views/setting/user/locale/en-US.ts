export default {
    ...
    'system.user.createNickUserName': 'Nick Name',
    'system.user.createNickUserNameNotNull': 'Nick name cannot be blank',
    'system.user.createNickUserNameOverLength': 'Nick name length cannot exceed 50',
    'system.user.createNickUserNamePlaceholder': 'Please enter user nick name',
