...
import cn.master.horde.common.uid.utils.TimeUtils;
import cn.master.horde.common.uid.worker.WorkerIdAssigner;
...
public class DefaultUidGenerator implements DisposableBean {
    ...
    public long getUID() throws BizException {
        try {
            return nextId();
        } catch (Exception e) {
     ...
     *
     * @return UID
     * @throws BizException in the case: Clock moved backwards; Exceeds the max timestamp
     */
